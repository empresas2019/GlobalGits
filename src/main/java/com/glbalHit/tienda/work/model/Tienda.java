...
public class Tienda {
     ...
     * @return productos List Que contiene todos los productos del almacen.
     */    
     ...
     * @return ventas List Retorna una lista de productos vendidos.
     */    
     ...
     * @param productos Objeto de tipo List que representa la nueva lista de productos de la tienda.
     */    
     ...
     * @param ventas Objeto de tipo List Que representa la nueva lista de las ventas realizadas en el almacen.
     */    
